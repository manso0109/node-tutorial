...
const payloadInBase64Format = jwtParts[1]
const signatureInBase64Format = jwtParts[2]

verifyFunction.write(headerInBase64Format+ '.' + payloadInBase64Format)
verifyFunction.end()

const jwtSignatureBase64 = base64url.toBase64(signatureInBase64Format)

const PUB_KEY = fs.readFileSync(__dirname + '/pub_key.pem' , 'utf8')

const signatureValid = verifyFunction.verify(PUB_KEY,jwtSignatureBase64,'base64')

console.log(signatureValid);
// const decodedHeader = base64url.decode(headerInBase64Format) 
// const decodedPayload = base64url.decode(payloadInBase64Format)
